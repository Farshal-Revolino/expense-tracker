    ...
    <>
      <div className="p-5 border-b border-slate-200/50 dark:border-white/[0.06]">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold text-blue-600 dark:text-blue-400 uppercase tracking-widest">Personal Finance</p>
          </div>
        </div>
      </div>
      ...
      {user && (
        <div className="px-5 py-4 border-b border-slate-200/50 dark:border-white/[0.06]">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-blue-400 via-blue-500 to-blue-700 flex items-center justify-center text-white text-sm font-bold flex-shrink-0 shadow-lg shadow-blue-500/25">
        ...
        {NAV_ITEMS.map((item) => (
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 ${
              currentTab === item.id
                ? 'sidebar-active-glow text-blue-700 dark:text-blue-400 font-bold border border-blue-200/50 dark:border-blue-500/20'
